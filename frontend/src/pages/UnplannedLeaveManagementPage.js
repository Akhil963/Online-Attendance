      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-slate-600 mt-2">Create and manage unplanned leaves for employees</p>
            </div>
            <button
        ...
        {showForm && (
          <div className="bg-white rounded-xl shadow-lg p-8 mb-8 border-2 border-blue-200">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-slate-900">Create New Unplanned Leave</h2>
              <button
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full border-2 border-slate-300 rounded-lg p-3 focus:outline-none focus:border-blue-500 h-24 resize-none"
                  required
                />
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 border-2 border-blue-200">
            <p className="text-slate-600 text-sm font-semibold">Total Unplanned Leaves</p>
          ...
          <div className="bg-gradient-to-br from-amber-50 to-amber-100 rounded-xl p-6 border-2 border-amber-200">
            <p className="text-slate-600 text-sm font-semibold">Pending</p>
