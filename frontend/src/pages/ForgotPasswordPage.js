...
const ForgotPasswordPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      await authAPI.forgotPassword(email.toLowerCase(), 'employee');
            ...
            <div className="relative z-10">
              ...
              <div className="bg-gray-900 rounded-3xl p-6 mb-10 text-left border border-white/10 shadow-2xl">
                <p className="text-xs font-medium text-gray-400 uppercase tracking-wide leading-relaxed">
                  <span className="text-blue-400">IMPORTANT:</span> Link expires in 24 hours. Check spam folder if you don't receive the email.
                </p>
              </div>
